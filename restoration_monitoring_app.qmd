...
ui <- navbarPage(
  ...
  tabPanel("Map",
    div(class="outer",
      ...
      actionButton("model_location", "Model restoration"),

    textOutput("print_location"),
    textOutput("location_warning"),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$model_location, {
    ...
    if(loc$geometry$type == "Polygon"){
      ...
      if(area > 40){
        showModal(modalDialog('Polygon size has to be smaller than 40 Hecatares', footer=NULL))
        Sys.sleep(3)
        removeModal()
      }
